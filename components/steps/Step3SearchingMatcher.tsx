...
export function Step3SearchingMatcher({ city, county, onComplete }: Step3Props) {
  ...
  return (
    <div className="py-6 space-y-7 text-center animate-fade-in">
      {/* Brand Header */}
      <HammerHouseLogo size="md" align="center" />

      {/* Main Title & Subtitle */}
      <div className="space-y-2 pt-1">
        <h2 className="font-sans text-2xl sm:text-[28px] font-bold text-[#0F172A] leading-snug">
          Searching Florida Network...
        </h2>
        <div className="flex items-center justify-center gap-1.5 text-sm font-medium text-[#64748B]">
      ...
      <div className="relative w-32 h-32 mx-auto flex items-center justify-center">
        ...
        <div className="relative z-10 w-14 h-14 rounded-2xl bg-white border-2 border-[#8B1122] shadow-sm flex items-center justify-center">
          <svg
      ...
      <div className="max-w-md mx-auto bg-[#F8FAFC] border border-slate-200 rounded-2xl p-4.5 text-left space-y-3 shadow-sm">
        {/* Checkpoint 1 */}
